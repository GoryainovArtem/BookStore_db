...
SELECT * FROM customer_votes_range_by_genres;
...
SELECT * FROM customer_votes_range_by_writers;


-- Витрина изначальная стоимость покупки / потраченные деньги для пользователя --
CREATE OR REPLACE VIEW price_and_paid AS (
WITH buf AS (
...
SELECT * FROM price_and_paid;


-- Витрина "Продажи магазинов" --
CREATE OR REPLACE VIEW shops_sales AS (
	WITH buf AS (
...
DROP TABLE languages_series_bindings CASCADE;
DROP TABLE series CASCADE;
DROP TABLE bindings CASCADE;
DROP TABLE publisher_series CASCADE;
DROP TABLE books_series CASCADE;
DROP TABLE shops_books CASCADE;
DROP TABLE shops CASCADE;
DROP TABLE customers CASCADE;
DROP TABLE purchases CASCADE;
DROP TABLE delivery_types CASCADE;
DROP TABLE purchases_detailed CASCADE;
DROP TABLE customers_votes CASCADE;
DROP TABLE publishers CASCADE;
DROP TABLE books CASCADE;
DROP TABLE books_writers CASCADE;
